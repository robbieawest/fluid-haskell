...
/* package fluid-haskell-0.1.0.0 */
#ifndef VERSION_fluid_haskell
#define VERSION_fluid_haskell "0.1.0.0"
#endif /* VERSION_fluid_haskell */
#ifndef MIN_VERSION_fluid_haskell
#define MIN_VERSION_fluid_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fluid_haskell */
...
#define CURRENT_COMPONENT_ID "fluid-haskell-0.1.0.0-inplace-fluid-haskell"
